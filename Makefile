...
clean :: clean_subdirs
	- $(RM_F) \
	  ...
	  perlmain.c core.[0-9] \
	  $(BASEEXT).exp $(INST_ARCHAUTODIR)/extralibs.all \
	  *perl.core perl$(EXE_EXT) \
	  $(BASEEXT).x mon.out \
	  $(MAKE_APERL_FILE) core.[0-9][0-9][0-9][0-9] \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'abstract: '\''The Swiss army knife for tests of Tarantool related Perl and lua code.'\''' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   "abstract" : "The Swiss army knife for tests of Tarantool related Perl and lua code.",' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>The Swiss army knife for tests of Tarantool related Perl and lua code.</ABSTRACT>' >> $(DISTNAME).ppd
